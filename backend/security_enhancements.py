...
class SecurityHeaders:
    ...
    def get_headers() -> Dict[str, str]:
        ...
        return {
            ...
            "Content-Security-Policy": "default-src 'self' https:; upgrade-insecure-requests; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self';",
