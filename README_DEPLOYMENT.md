...
✅ **API Key**: set `ANTHROPIC_API_KEY` in Railway Variables (never commit the real value)  
✅ **Stored in**: `.env` file locally (git-ignored) and Railway Variables in production  
