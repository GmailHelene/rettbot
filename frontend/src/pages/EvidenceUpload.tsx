...
export default function EvidenceUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      // Note: In production, this should upload to secure storage
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            ...
            <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1">
              <li>• Alle filer krypteres med AES-256 før lagring</li>
              <li>• Kun du har tilgang til dekrypteringsnøkkel</li>
              <li>• Filer lagres på sikre servere i Norge</li>
              <li>• Automatisk sletting etter 90 dager (kan konfigureres)</li>
