...
RettBot+ implements a **zero-knowledge architecture** where the server has no access to user data in plaintext. All encryption and decryption happens client-side in the user's browser.
...
- ✅ **GDPR**: Right to be forgotten (crypto erasure)
- ✅ **ECHR Article 8**: Right to privacy
- ✅ **Norwegian Personal Data Act**: Full compliance
- ✅ **Attorney-Client Privilege**: Treated as privileged communication
