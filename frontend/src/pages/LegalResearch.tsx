                  ...
                  <div className="space-y-3">
                    {result.research.norwegian_laws.map((law, index) => (
                      <div key={index} className="border-l-4 border-blue-500 pl-4 py-3 bg-blue-50 dark:bg-blue-900/20 rounded-r">
                        <p className="text-gray-900 dark:text-white font-medium">{law}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {result.research.echr_cases.map((echrCase, index) => (
                      <div key={index} className="border-l-4 border-purple-500 pl-4 py-3 bg-purple-50 dark:bg-purple-900/20 rounded-r">
                        <p className="text-gray-900 dark:text-white font-medium">{echrCase}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {result.research.precedents.map((precedent, index) => (
                      <div key={index} className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 dark:bg-green-900/20 rounded-r">
                        <p className="text-gray-900 dark:text-white font-medium">{precedent}</p>
                      </div>
                    ))}
                  </div>
                </div>
