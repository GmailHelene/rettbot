...
# GoatCounter ligger fast i index.html (overlever service-worker-cachen), så
# hostene tillates alltid i CSP - uavhengig av miljøvariabler.
_CSP_SCRIPT_EXTRA = (
    " https://gc.zgo.at"
